...
class AuditlogLog(models.Model):
    ...
    line_ids = fields.One2many("vin_auditlog.log.line", "log_id", string="Fields updated")
...
class AuditlogLogLine(models.Model):
    ...
    log_id = fields.Many2one(
        "vin_auditlog.log", string="Log", ondelete="cascade", index=True
    )
